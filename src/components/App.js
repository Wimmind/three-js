...
export default class App extends Component {
  ...
  mainSphere = new Sphere('main');
  otherSphere = new Sphere('other');
  arrows = new Arrows('arrowGroup');
  ...
  componentDidMount() {
    ...
    this.myScene.initBaseControls();

    //this.initMainSphere(src, siblings, coords);
    this.mainSphere.createMesh({
    ...
    this.myScene.addObject(
      this.arrows.arrowGroup
    );

    this.myScene.mainSphere = this.mainSphere.sphere;
    this.myScene.otherSphere = this.otherSphere.sphere;
    this.myScene.arrowGroup = this.arrows.arrowGroup;
    ...
    console.log(this.myScene.scene)
  }
